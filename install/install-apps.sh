...
# Install packages
sudo pacman -S alacritty alsa-utils bluez bluez-utils cargo clang cmake exa fd fuse fzf github-cli interception-tools interception-dual-function-keys jq libnotify light mpv mutt neovim npm openssh python python-pip pulseaudio pulseaudio-bluetooth ripgrep rsync rustup sd texlive-core tmux ttf-font-awesome ttf-nerd-fonts-symbols unrar unzip wget xdg-user-dirs zip zsh zsh-syntax-highlighting zathura zathura-pdf-mupdf zsh-autosuggestions
